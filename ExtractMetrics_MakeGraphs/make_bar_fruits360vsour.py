...
species = ("Centre-Loss", "Proxy-NCA", "Siamese", "Triplet" )
penguin_means = {
    'Self-checkout': (0.979, 0.985, 0.981, 0.980),     # data from roc_bymethod_bestdist.png
    'Fruits 360': (1.000, 0.996, 0.976, 0.997),          # data from roc_bymethod_bestdist_fruits360.png
}
...
#y_ticks=["0.950","1.000"]
ax.set_yticks([.97, .98, .99, 1.], ["0.970","0.980","0.990","1.000"])
