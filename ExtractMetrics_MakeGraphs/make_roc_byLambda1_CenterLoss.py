...
plot_title = r"Center Loss Verification ROC AUC ~ Center-Loss Weight $\lambda$1"
legend_title = r"AUC = f ( $\lambda$1 )"
dest_filename = "roc_byLambda1_CenterLoss.png"

experSuffixes = {
    '1.000': experSuffix_names_cl(experName="lambda1", lambda1="1.000", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
    '0.300': experSuffix_names_cl(experName="lambda1", lambda1="0.300", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
    '0.100': experSuffix_names_cl(experName="lambda1", lambda1="0.100", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
    '3.000': experSuffix_names_cl(experName="lambda1", lambda1="3.000", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
    '9.900': experSuffix_names_cl(experName="lambda1", lambda1="9.900", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
    '0.030': experSuffix_names_cl(experName="lambda1", lambda1="0.030", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
    '0.010': experSuffix_names_cl(experName="lambda1", lambda1="0.010", preClIndex="0", dist_name="xxx",
                                  prelast_size=512, p_minkowski=0, inclInterCenter=False, lambda2=0),
}
bold_index = 0
