...
plot_title = "Siamese Verification ROC AUC ~ Trainable Layers"
legend_title = "AUC = f (Number of Trainable Layers)"
dest_filename = "roc_byCntTrainable_Siamese.png"

experSuffixes = {
    'Last 2 Dense blocks': suffix_name_siam(1),
    'Last 1 Dense block': suffix_name_siam(2),
    'All': suffix_name_siam(0),
}
bold_index = 0
