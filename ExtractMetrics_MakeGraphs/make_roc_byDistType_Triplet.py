...
plot_title = "Triplet Verification ROC AUC ~ Distance Type"
legend_title = "AUC = f (Distance Type)"
dest_filename = "roc_byDistType_Triplet.png"

experSuffixes = {
    'Euclidean': suffix_name_triplet(5),
    'Minkowski (p=3)': suffix_name_triplet(6),
    'Minkowski (p=4)': suffix_name_triplet(7),
    'Manhattan': suffix_name_triplet(4),
    'Cosine': suffix_name_triplet(8)
}
bold_index = 0
