...
plot_title = "Triplet Verification ROC AUC ~ Trainable Layers"
legend_title = "AUC = f (Number of Trainable Layers)"
dest_filename = "roc_byCntTrainable_Triplet.png"

experSuffixes = {
    'Last 2 Dense blocks': suffix_name_triplet(2),
    'Last 1 Dense block': suffix_name_triplet(3),
    'All': suffix_name_triplet(1),
}
bold_index = 0
