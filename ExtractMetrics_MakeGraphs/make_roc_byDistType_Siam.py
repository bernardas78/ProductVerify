...
plot_title = "Siamese Verification ROC AUC ~ Distance Type"
legend_title = "AUC = f (Distance Type)"
dest_filename = "roc_byDistType_Siamese.png"

experSuffixes = {
    'Cosine': suffix_name_siam(7),
    'Minkowski (p=3)': suffix_name_siam(5),
    'Manhattan': suffix_name_siam(3),
    'Minkowski (p=4)': suffix_name_siam(6),
    'Euclidean': suffix_name_siam(4),
}
bold_index = 0
