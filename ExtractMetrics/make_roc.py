...
for i,cnt_neurs in enumerate(lst_cnt_neurs):
    roc_file = open(r"A:\IsKnown_Results\Dists\roc_data_{}_{}_{}.h5".format(cnt_neurs,dist_name,p_minkowski), 'rb')
...
plt.savefig (r"A:\IsKnown_Results\Dists\roc_{}_{}.png".format(dist_name,p_minkowski))
plt.close()
