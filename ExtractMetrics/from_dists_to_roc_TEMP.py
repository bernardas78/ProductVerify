...
#for cnt_neurs in lst_cnt_neurs:
    ...
    dists_file = os.path.join ( Glb.results_folder, "Dists", r"A:\IsKnown_Results\Dists\dists_768_Eucl.csv" )
    ...
    print ("y_score min/max {}/{}".format(np.min(y_score), np.max(y_score)))
    ...
    roc_file = open(r"A:\IsKnown_Results\Dists\roc_data_768_Eucl_TEMP.h5", 'wb')
